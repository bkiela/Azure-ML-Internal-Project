...
model = tf.keras.models.load_model(r'azure-ml-internal-project\pipeline\training\models\best_gaussian_autoencoder_model.keras')
...
for country in random_countries:
    ...
    plt.scatter(anomalous_country_data['Year-Week'], anomalous_country_data['Confirmed'], c='red', marker='o')
